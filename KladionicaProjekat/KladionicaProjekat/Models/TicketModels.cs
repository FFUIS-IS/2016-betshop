...
namespace KladionicaProjekat.Models
{
    class TicketModels
    {
        ...
        public TicketModels(int id, DateTime date_of_payment, DateTime time_payment, string ticket_control_number, float payment_amountint, int player_Id, string system, int workpeople_Id, int code_betting_shop_Id)
        {
            Id = id;
